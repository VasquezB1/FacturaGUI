...
import static ec.edu.ups.vista.factura.CreateFactura.x;
...
public static String x;
 private ControladorFactura controladorFactura;
     ...
     */
    public DeleteFactura(ControladorFactura controladorFactura,ResourceBundle mensajes) {
        initComponents();
         x="x";
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
        // TODO add your handling code here:
        String numero = String.valueOf(txtnumerofac.getText());
        Factura factura = controladorFactura.read(Integer.parseInt(numero));
        ...
        vaciarTabla();
        llenarDatos();
        controladorFactura.delete(Integer.parseInt(numero));
        }
